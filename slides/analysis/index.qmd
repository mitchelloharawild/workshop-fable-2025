...
![](resources/projector-screen-outline.svg){.icon} [workshop.nectric.com.au/fable-2025/](https://workshop.nectric.com.au/fable-2025/)

![](resources/github.svg){.icon} [mitchelloharawild/workshop-fable-2025](https://github.com/mitchelloharawild/workshop-fable-2025)
...
[<https://workshop.nectric.com.au/fable-2025/>]{.fragment}
...
library(fpp3)
read.csv(
  "https://workshop.nectric.com.au/fable-2025/data/tourism.csv"
)
```
